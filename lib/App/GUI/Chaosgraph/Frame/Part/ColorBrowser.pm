...
package App::GUI::Chaosgraph::Frame::Part::ColorBrowser;
use base qw/Wx::Panel/;
use App::GUI::Chaosgraph::SliderCombo;
use App::GUI::Chaosgraph::ColorDisplay;
...
sub new {
    ...
    $self->{'red'}   =  App::GUI::Chaosgraph::SliderCombo->new( $self, 100, ' R  ', "red part of $type color",    0, 255,  0);
    $self->{'green'} =  App::GUI::Chaosgraph::SliderCombo->new( $self, 100, ' G  ', "green part of $type color",  0, 255,  0);
    $self->{'blue'}  =  App::GUI::Chaosgraph::SliderCombo->new( $self, 100, ' B  ', "blue part of $type color",   0, 255,  0);
    $self->{'hue'}   =  App::GUI::Chaosgraph::SliderCombo->new( $self, 100, ' H  ', "hue of $type color",         0, 359,  0);
    $self->{'sat'}   =  App::GUI::Chaosgraph::SliderCombo->new( $self, 100, ' S  ', "saturation of $type color",  0, 100,  0);
    $self->{'light'} =  App::GUI::Chaosgraph::SliderCombo->new( $self, 100, ' L  ', "lightness of $type color",   0, 100,  0);
    $self->{'display'}= App::GUI::Chaosgraph::ColorDisplay->new( $self, 25, 10, $init);
