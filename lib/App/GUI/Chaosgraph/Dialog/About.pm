...
package App::GUI::Chaosgraph::Dialog::About;
use base qw/Wx::Dialog/;

sub new {
    my ( $class, $parent) = @_;
    my $self = $class->SUPER::new( $parent, -1, 'About Wx::GUI::Chaosgraph' );

    my @lblb_pro = ( [-1,-1], [-1,-1], &Wx::wxALIGN_CENTRE_HORIZONTAL );
    my $version = Wx::StaticText->new( $self, -1, $App::GUI::Chaosgraph::NAME . '    version '.$App::GUI::Chaosgraph::VERSION , @lblb_pro);
    ...
    my $url     = Wx::HyperlinkCtrl->new( $self, -1, 'metacpan.org/dist/App::GUI::Chaosgraph', 'https://metacpan.org/dist/App::GUI::Chaosgraph' );
