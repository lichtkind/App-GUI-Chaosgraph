...
package App::GUI::Chaosgraph;
our $NAME = __PACKAGE__;
our $VERSION = '0.01';

use base qw/Wx::App/;
use App::GUI::Chaosgraph::Frame;

sub OnInit {
    my $app   = shift;
    my $frame = App::GUI::Chaosgraph::Frame->new( undef, 'Chaosgraph '.$VERSION);
    $frame->Show(1);
...
App::GUI::Chaosgraph - draw art by systems of dynamic equations
...
=for HTML <p>
<img src="https://raw.githubusercontent.com/lichtkind/App-GUI-Harmonograph/POD/examples/wirbel.jpg"    alt=""  width="300" height="300">
